...
numusers_all = pd.read_csv('2022_new/STEP_3_0_clean_data/numusers_all.csv',names = ['month_year','num_users','tool_name_version'],skiprows = 1)
...
numusers_all_inverted.to_csv('2022_new/STEP_3_1_chart_views/numusers_all_inverted.csv')

# ### invert the numjobs_all csv file
# numjobs_all = pd.read_csv('2022_new/STEP_3_0_clean_data/numjobs_all.csv',names = ['month_year','num_jobs','tool_name_version'],skiprows = 1)
...
# numjobs_all_inverted.to_csv('2022_new/STEP_3_1_chart_views/numjobs_all_inverted.csv')

# ### invert the total_cpu_time_all csv file
# total_cpu_time_all = pd.read_csv('2022_new/STEP_3_0_clean_data/total_cpu_time_all.csv',names = ['month_year','total_cpu_time','tool_name_version'],skiprows = 1)
...
# total_cpu_time_all_inverted.to_csv('2022_new/STEP_3_1_chart_views/total_cpu_time_all_inverted.csv')

# ### invert the totalmemory_all csv file
# totalmemory_all = pd.read_csv('2022_new/STEP_3_0_clean_data/totalmemory_all.csv',names = ['month_year','totalmemory','tool_name_version'],skiprows = 1)
...
# totalmemory_all_inverted.to_csv('2022_new/STEP_3_1_chart_views/totalmemory_all_inverted.csv')

### invert the avg_cpu_time_all csv file
# avg_cpu_time_all = pd.read_csv('2022_new/STEP_3_0_clean_data/avg_cpu_time_all.csv',names = ['month_year','avg_cpu_time','tool_name_version'],skiprows = 1)
...
# avg_cpu_time_all_inverted.to_csv('2022_new/STEP_3_1_chart_views/avg_cpu_time_all_inverted.csv')

# ### invert the avgmemory_all csv file
# avgmemory_all = pd.read_csv('2022_new/STEP_3_0_clean_data/avg_memory_all.csv',names = ['month_year','avgmemory','tool_name_version'],skiprows = 1)
...
# avgmemory_all_inverted.to_csv('2022_new/STEP_3_1_chart_views/avgmemory_all_inverted.csv')