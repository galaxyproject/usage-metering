...
d3.csv("numjobs_numusers.csv", function(data) {


  var xMax = d3.max(data, function(d) { return +d.num_jobs; }),
      xMin = d3.min(data, function(d) { return +d.num_jobs; }),
      xMin = xMin > 0 ? 0 : xMin,
      yMax = d3.max(data, function(d) { return +d.num_users; }),
      yMin = d3.min(data, function(d) { return +d.num_users; }),
      yMin = yMin > 0 ? 0 : yMin;
  ...
  objects.selectAll(".dot")
    ...
    .enter().append("circle")
      .classed("dot", true)
      .attr("r", 1.5)
      .attr("transform", function(d) { return "translate(" + x(d.num_jobs) + "," + y(d.num_users) + ")"})
