...
select cpu_usage.tool_id,extract(month from cpu_usage.create_time) as month,extract(year from cpu_usage.create_time) as year,AVG(cpu_usage.cpu_usage * runtime_seconds.runtime_seconds) as total_cpu_time
