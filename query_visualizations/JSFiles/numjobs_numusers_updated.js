...
//Read the data
chart = d3.csv("numjobs_numusers.csv", function(data) {
  ...
  var mousemove = function(d) {
    tooltip
      .html("Tool_name_version: " + d.tool_name_version + "<br>Numjobs:" + d.num_jobs + "<br>Numusers:" + d.num_users)
  ...
  scatter
    ...
    .append("circle")
      ...
      .attr("cy", function (d) { return y(d.num_users); } )
      .attr("r", 1)
      .style("fill", "green")
      .style("opacity", 1)
  ...
  function updateChart() {
    ...
    scatter
      .selectAll("circle")
        ...
        .attr('cy', function(d) {return newY(d.num_users)})
